...
Function Install-PhpNightly {
  Invoke-WebRequest -Verbose -MaximumRetryCount 10 -UseBasicParsing -Uri $php_builder/releases/latest/download/Get-PhpNightly.ps1 -OutFile $php_dir\Get-PhpNightly.ps1
